...
6. In **Build settings → Custom error responses**, set `404.html` as the NotFound document so broken links display the branded fallback page.
7. Complete the wizard to trigger the initial deploy.
